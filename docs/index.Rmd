...
function getURL(report, country) {
  ...
  var latest_monday = getMonday(new Date());
  
  var dd = String(latest_monday.getDate()).padStart(2, '0');
  var mm = String(latest_monday.getMonth() + 1).padStart(2, '0'); //January is 0!
  var yyyy = latest_monday.getFullYear();
  date = yyyy + '-' + mm + '-' + dd;
