...
On March 8th, the [European Forecast Hub](https://covid19forecasthub.eu/) launched and we expanded our crowd forecast app which now incluedes a set of 32 countries. Some things have changed with the European Forecast Hub: 

1. **data now gets updated every Sunday at 8.30am CET** and the **submission deadline is Monday at 11pm CET (10pm UK time)**
2. The new evaluation is now at https://epiforecasts.io/europe-covid-forecast/. You can still access the old evaluation for past forecasts in Germany and Poland at https://epiforecasts.io/covid.german.forecasts. 
3. You now need to make a choice which countries to forceast. We encourage you to keep submitting forecasts for Germany and Poland at least unitl the end of March! (That's when the official study period of the GM/PL Forecast Hub ends)
...
Now, let's have a look at last weeks forecasts and performance! For this week, we are still only showing forecasts for Germany and Poland, but we intend to change that in the near future. 
