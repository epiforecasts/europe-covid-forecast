...
We're very excited to announce the UK Covid-19 Crowd Forecasting Challenge! Starting May 24th we will pay extra attention to your forecasts for the United Kingdom. The best forecaster can win a cash prize of 100 GBP. In order to participate, all you need to do is submit a forecast for the UK over the coming 12 weeks. If you miss a week that is no problem - you will be assigned the median score of all forecasters who participated that week. Find more information on the project [here](https://www.crowdforecastr.org/2021/05/11/uk-challenge/). 

Forecasts can be made between Sunday 10am and Monday 10pm UK time. 
